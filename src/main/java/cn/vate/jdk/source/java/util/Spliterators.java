...
public final class Spliterators {
    ...
    public static abstract class AbstractSpliterator<T> implements Spliterator<T> {
         ...
         * 这个方法是切分出一个子集
         * 有两种结果：
         * 1. 切分出的子集已经包含了所有剩下元素，那就相当于切分完成了
         * 2. 切分出的子集，只包含了部分元素，那就继续调用这个方法，切分出更多子集
         *
         */
        @Override
        public Spliterator<T> trySplit() {
    ...
    public static void main(String[] args) {
        ...
        IteratorSpliterator<String> stringIteratorSpliterator = new IteratorSpliterator<>(strings, 0);
        stringIteratorSpliterator.forEachRemaining(System.out::println);
        stringIteratorSpliterator.forEachRemaining(System.out::println);
        stringIteratorSpliterator.forEachRemaining(System.out::println);
    }
}
